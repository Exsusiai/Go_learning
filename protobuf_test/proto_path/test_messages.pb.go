...
type FrameHeader struct {
	...
	FrameLength int32 `protobuf:"varint,3,opt,name=frameLength,proto3" json:"frameLength,omitempty"`
}
...
func (x *FrameHeader) GetFrameId() int32 {
	if x != nil {
		return x.FrameId
	}
	return 0
...
func (x *FrameHeader) GetFrameLength() int32 {
	if x != nil {
...
var file_test_messages_proto_rawDesc = []byte{
	...
	0x6e, 0x67, 0x74, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x66, 0x72, 0x61, 0x6d,
